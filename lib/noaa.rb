...
%w(configuration current_conditions forecast forecast_summary forecast_day http_service station station_writer).each { |file| require File.join(File.dirname(__FILE__), 'noaa', file) }
